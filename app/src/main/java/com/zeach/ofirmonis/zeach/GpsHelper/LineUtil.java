package com.zeach.ofirmonis.zeach.GpsHelper;
...
class LineUtil {
     ...
     * @param X2 ,&nbsp;Y2 the coordinates of the end of the first specified
     *           line segment
     * @param X3 ,&nbsp;Y3 the coordinates of the beginning of the second
     *           specified line segment
     * @param X4 ,&nbsp;Y4 the coordinates of the end of the second specified
     *           line segment
     ...
     *
     * @param X1 ,&nbsp;Y1 the coordinates of the beginning of the specified
     *           line segment
